...
import { idlFactory } from './dBank_App_frontend.did.js';
export { idlFactory } from './dBank_App_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DBANK_APP_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dBank_App_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dBank_App_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dBank_App_frontend.did.js")._SERVICE>}
 */
export const dBank_App_frontend = createActor(canisterId);
